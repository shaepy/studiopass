...
Use the Admin Credentials if needing to test out features for role of "owner". This demo is styled for a ballet studio, but the system is flexible and can be adapted for any type of studio or class-based business.
